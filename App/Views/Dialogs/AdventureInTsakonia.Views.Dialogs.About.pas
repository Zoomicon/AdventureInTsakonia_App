...
unit AdventureInTsakonia.Views.Dialogs.About;
...
interface
  ...
  uses
    ...
    READCOM.Resources.Icons, System.ImageList; //for Icons.SVGIconImageList
  {$endregion}
...
implementation
  ...
  uses
    ...
    READCOM.App.Messages; //assuming AdventureInTsakonia.App.Messages has been used by AdventureInTsakonia_App.dpr (since it overrides values of strings defined in this unit)
  {$endregion}
